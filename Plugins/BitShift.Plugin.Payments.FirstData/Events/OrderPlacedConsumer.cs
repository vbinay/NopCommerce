...
namespace BitShift.Plugin.Payments.FirstData.Events
{
    public class OrderPlacedConsumer : IConsumer<OrderPlacedEvent>
    {
        ...
        public void HandleEvent(OrderPlacedEvent e)
        {
            ...
            {
                _genericAttributeService.SaveAttribute(e.Order, Constants.TransactionCardType, cardTypeAttribute.Value);
                _genericAttributeService.SaveAttribute(e.Order.Customer, Constants.TransactionCardType, "");
            }
            ...
            if (e.Order.PaymentMethodSystemName == "BitShift.Payments.FirstData" &&
               ...
               (_firstDataStoreSetting.TransactionMode == (int)TransactMode.AuthorizeAndCaptureAfterOrder ||
                _firstDataStoreSetting.TransactionMode == (int)TransactMode.HostedPaymentPage))
            {
                try
                {
