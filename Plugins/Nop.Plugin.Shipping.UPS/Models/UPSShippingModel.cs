...
namespace Nop.Plugin.Shipping.UPS.Models
{
    public class UPSShippingModel
    {
        ...
        [NopResourceDisplayName("Plugins.Shipping.UPS.Fields.ShipmentConfirmUrl")]
        public string ShipmentConfirmUrl { get; set; }

        [NopResourceDisplayName("Plugins.Shipping.UPS.Fields.ShipmentAcceptUrl")]
        public string ShipmentAcceptUrl { get; set; }
