...
namespace Nop.Plugin.Shipping.StoresPickup.Controllers
{
    ...
    public class ShippingStoresPickupController : Controller
    {
       ...
       // private readonly ICountryService _countryService;
        ...
        {
            var model = new StoresPickupModel();
            model.Stores = _ffSettings.Stores;
         
            ViewBag.Debug = "Prueba del controlador";
            return View("~/Plugins/Shipping.StoresPickup/Views/ShippingStoresPickup/Configure.cshtml", model);
        }

        [HttpPost]
        [ChildActionOnly]
        public ActionResult Configure(StoresPickupModel model)
        {
            ...
            //save settings
            _ffSettings.Stores = model.Stores;
