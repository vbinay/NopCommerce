...
namespace SAPFileFeed
{
    ...
    public partial class SapFileFeed : DbContext
    {
        public SapFileFeed()
            : base("name=SapFileFeed")
        {
        }
        ...
        [DbFunction("SapFileFeed", "nop_splitstring_to_table")]
        public virtual IQueryable<nop_splitstring_to_table_Result> nop_splitstring_to_table(string @string, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<nop_splitstring_to_table_Result>("[SapFileFeed].[nop_splitstring_to_table](@string, @delimiter)", stringParameter, delimiterParameter);
        }
