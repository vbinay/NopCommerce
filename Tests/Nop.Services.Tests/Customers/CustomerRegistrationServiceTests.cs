...
namespace Nop.Services.Tests.Customers
{
    ...
    public class CustomerRegistrationServiceTests : ServiceTest
    {
        ...
        private IRepository<Commuter> _commuterRepo;
        ...
        private IRepository<StoreMapping> _storeMappingRepo;
        ...
        public new void SetUp()
        {
            ...
            _commuterRepo = MockRepository.GenerateMock<IRepository<Commuter>>();

            _storeMappingService = MockRepository.GenerateMock<IStoreMappingService>();

            _logger = new NullLogger();

            _customerService = new CustomerService(new NopNullCache(), _customerRepo, _commuterRepo, _customerRoleRepo,
                _genericAttributeRepo, _orderRepo, _forumPostRepo, _forumTopicRepo,
                null, null, null, null, null,
                _genericAttributeService, null, null, _eventPublisher, _customerSettings, null, _storeMappingRepo);
            _customerRegistrationService = new CustomerRegistrationService(_customerService,
                _encryptionService, _newsLetterSubscriptionService, _localizationService,
                _storeService, _rewardPointService, _genericAttributeService, _storeMappingService, _rewardPointsSettings, _customerSettings, _logger );
        }
