...
namespace Nop.Services.Tests.Orders
{
    ...
    public class OrderProcessingServiceTests : ServiceTest
    {
        ...
        private IGlCodeService _glCodeService;
        private IRepository<StoreMapping> _storeMappingRepository;
        private IRepository<VendorMapping> _vendorMappingRepo;
        private ISAPService _sapService;
        private IRepository<TaxResponseStorage> _taxResponseStorageRepo;
        ...
        public new void SetUp()
        {
            ...
            _vendorMappingRepo = MockRepository.GenerateMock<IRepository<VendorMapping>>();
            ...
            _shippingService = new ShippingService(_shippingMethodRepository, 
                ...
                cacheManager, _storeMappingRepository,_catalogSettings,_vendorMappingRepo);
            ...
            _donationService = MockRepository.GenerateMock<IDonationService>();
            ...
            _mealPlanService = MockRepository.GenerateMock<IMealPlanService>();
            _customerSettings = new CustomerSettings();

            _taxCategoryService = MockRepository.GenerateMock<ITaxCategoryService>();
            _glCodeService = MockRepository.GenerateMock<IGlCodeService>();

            _sapService = MockRepository.GenerateMock<ISAPService>();
           ...
           // _taxService = new TaxService(_addressService, _workContext, _storeContext, _taxSettings,
               // pluginFinder, _geoLookupService, _countryService, _taxCategoryService, _stateProvinceService, _glCodeService,_shippingService, _logger,_customerSettings, _addressSettings, _taxResponseStorageRepo );

            _rewardPointService = MockRepository.GenerateMock<IRewardPointService>();
            _rewardPointsSettings = new RewardPointsSettings();

            _orderTotalCalcService = new OrderTotalCalculationService(_workContext, _storeContext,_storeService,
                _priceCalcService, _taxService, _shippingService, _paymentService,
                _checkoutAttributeParser, _discountService, _giftCardService,
                _genericAttributeService, _rewardPointService,
                _taxSettings, _rewardPointsSettings, _shippingSettings, _shoppingCartSettings, _catalogSettings,_httpContext);
            ...
            _messageTemplateService = MockRepository.GenerateMock<IMessageTemplateService>();
            ...
            //    _genericAttributeService, _countryService, _shippingSettings, _paymentSettings, _rewardPointsSettings,
            //    _orderSettings, _taxSettings, _localizationSettings,
            //    _currencySettings, _donationService, _mealPlanService, _sapService, _messageTemplateService, _glCodeService,_httpContext);
        }
