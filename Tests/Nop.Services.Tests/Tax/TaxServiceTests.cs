...
namespace Nop.Services.Tests.Tax
{
    ...
    public class TaxServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            _taxResponseStorageRepo = MockRepository.GenerateMock<IRepository<TaxResponseStorage>>();
            ...
            //    , _taxCategoryService, _stateProvinceService, _glCodeService, _shippingService, _logger, _customerSettings, _addressSettings, _taxResponseStorageRepo);
        }
        ...
        {
            var provider = _taxService.LoadActiveTaxProvider(404);
            provider.ShouldNotBeNull();
        }
        ...
        public void Can_get_productPrice_priceIncludesTax_includingTax_taxable()
        {
            ...
            decimal taxRate;
            _taxService.GetProductPrice(product, 0, 1000M, false, customer, true, false, out taxRate).ShouldEqual(1000);
            _taxService.GetProductPrice(product, 0, 1100M, false, customer, false, false, out taxRate).ShouldEqual(1100);
            _taxService.GetProductPrice(product, 0, 909.0909090909090909090909091M, false, customer, true, false, out taxRate).ShouldEqual(909.0909090909090909090909091M);
            _taxService.GetProductPrice(product, 0, 1000M, false, customer, false, false, out taxRate).ShouldEqual(1000);
        }
