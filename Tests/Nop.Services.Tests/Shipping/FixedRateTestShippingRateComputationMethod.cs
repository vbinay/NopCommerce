...
namespace Nop.Services.Tests.Shipping
{
    public class FixedRateTestShippingRateComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public System.Collections.Generic.List<string> CreateShipmentWithUPSAPI(Core.Domain.Orders.OrderItem orderItem, Common.IAddressService addressService, ShippingSettings shippingSettings)
        {
