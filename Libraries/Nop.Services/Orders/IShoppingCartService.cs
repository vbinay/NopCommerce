...
namespace Nop.Services.Orders
{
    ...
    public partial interface IShoppingCartService
    {
        ...
        IList<string> GetStandardWarnings(Customer customer, ShoppingCartType shoppingCartType,
            ...
            decimal customerEnteredPrice, int quantity, bool isParentBundleProduct);
	    ...
	    /// <param name="getMealPlanWarnings">A value indicating whether we should validate meal plan properies</param>
        /// <returns>Warnings</returns>
        ...
        void UpdateShoppingCartItemForTieredShipping(ShoppingCartItem sci);

        void InsertAssociatedProductsPerShoppingCartItem(ShoppingCartBundleProductItem scbpi);

        void UpdateShoppingCartBundleProductItem(ShoppingCartBundleProductItem scbp);

        IList<ShoppingCartBundleProductItem> GetAssociatedProductsPerShoppingCartItem(int shoppingCartItemId);

        IList<ShoppingCartBundleProductItem> GetAssociatedProductsByOrderItemId(int orderItemId);

        IList<ShoppingCartBundleProductItem> GetAssociatedProductsByOrderId(int orderId);
        ...
        /// <param name="attributesXml">Attributes in XML format</param>
        /// <returns>Warnings</returns>
        IList<string> GetShoppingCartItemMealPlanWarnings(
