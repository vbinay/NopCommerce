...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        List<ProductGlCodeMapping> GetDetailsFromProductGlcodeMapping(int? orderId, int? orderItemId,int GlstatusType=1);
        ...
        void InsertProductCalculatedGlCodes(ProductGlCodeCalculation ProductGlCodeCalculation);

        void InsertJEBusinessLogicOrderDetails(OrderDetails orderDetails);

        //void InsertJeGlCodeAndAmountBusinessRules(ProductGlCodeMapping itemsMapping);

        void UpdateProductCalculatedGlCodes(ProductGlCodeCalculation ProductGlCodeCalculation);
        /// <summary>
        /// Search orders
        /// </summary>
        ...
        /// Search orders
        /// </summary>
        /// <param name="orderId">Order identifier; null to load all orders</param>
        /// <param name="vendorId">Vendor identifier; null to load all orders</param>
        /// <param name="createdFromUtc">Created date from (UTC); null to load all records</param>
        /// <param name="createdToUtc">Created date to (UTC); null to load all records</param>
        /// <param name="billingLastName">Billing last name. Leave empty to load all records.</param>
        /// /// <param name="productName">Product name. Leave empty to load all records.</param>
        /// <param name="pageIndex">Page index</param>
        /// <param name="pageSize">Page size</param>
        /// <returns>Orders</returns>
        IPagedList<ReservationModel> SearchReservations(int vendorId = 0, string orderId = "",
        ...
        /// </summary>
        /// <param name="reservedProducts"></param>
        void InsertReservedProduct(ReservedProduct reservedProduct);
