...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderReportService
    {
		...
		#region NU-71
        /// <summary>
        /// Search Deliveries by Unit orders
        /// </summary>
        ...
        /// <param name="sortOrder">The order in which to sort the data in</param>
        /// <param name="pageIndex">Page index</param>
        /// <param name="pageSize">Page size</param>
        /// <returns>Order collection</returns>
        IPagedList<OrderByDeliveryReportLine> SearchDeliveriesByUnit(int storeId = 0, DateTime? startDate = null, DateTime? endDate = null,
            string unitNumber = "", TimeZoneInfo timeZone = null, int pageIndex = 0, int pageSize = int.MaxValue);
