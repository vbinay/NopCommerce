...
namespace Nop.Services.Authentication
{
    ...
    public partial class FormsAuthenticationService : IAuthenticationService
    {
        ...
        public virtual void SignIn(Customer customer, bool createPersistentCookie)
        {
            ...
            //NU-90 change if (FormsAuthentication.CookieDomain != null)
            //  {

            if (!String.IsNullOrEmpty(WebConfigurationManager.AppSettings["CookieDomain"]))
            {
                cookie.Domain = WebConfigurationManager.AppSettings["CookieDomain"];
            }
            else
            {
