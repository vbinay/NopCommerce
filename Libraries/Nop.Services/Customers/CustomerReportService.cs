...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerReportService : ICustomerReportService
    {
        ...
        private readonly IStoreContext _storeContext;	// NU-42
        private readonly IRepository<StoreMapping> _storeMappingRepository;	// NU-42
        ...
        public CustomerReportService(IRepository<Customer> customerRepository,
            ...
            IStoreContext storeContext, // NU-42
            IRepository<StoreMapping> storeMappingRepository) 	// NU-42
        {
            this._customerRepository = customerRepository;
            this._orderRepository = orderRepository;
            this._customerService = customerService;
            this._dateTimeHelper = dateTimeHelper;
            this._storeContext = storeContext;	// NU-42
            this._storeMappingRepository = storeMappingRepository;	// NU-42
        }
			...
			int storeId = 0)	/// NU-42
        {
            ...
            if (storeId > 0)
            {
                query1 = from q in query1
                         join sm in _storeMappingRepository.Table on q.c.Id equals sm.EntityId
                         where sm.EntityName == "Customer" && sm.StoreId == storeId
                         select q;
            }
            #endregion
