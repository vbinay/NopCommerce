...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        private readonly IRepository<Commuter> _commuterRepository; //EC-5
        ...
        public CustomerService(ICacheManager cacheManager,
            ...
            IRepository<Commuter> commuterRepository, //EC-5
            ...
            IRepository<StoreMapping> storeMappingRepository) 	
        {
            ...
            this._commuterRepository = commuterRepository; //EC-5
            ...
            int storeId = 0) /// NU-42
        {
            ...
            if (storeId > 0)
            {
                query = from c in query
                        join sm in _storeMappingRepository.Table on c.Id equals sm.EntityId
                        where sm.StoreId == storeId
                            && sm.EntityName == "Customer"
                        select c;
            }
            #endregion

            query = query.OrderBy(c => c.Email);	// NU-44
            ...
            int storeId = 0) /// NU-42
        {
            ...
            {
                query = from c in query
                        join s in _storeMappingRepository.Table on c.Id equals s.EntityId
                        where s.EntityName == "Customer" &&
                            s.StoreId == storeId
                        select c;
            }
            #endregion
        ...
        #region NU-29
        public virtual Customer GetCustomerByIdAndStoreId(int customerId, int storeId)
        {
            Customer ret = null;
            ...
            else
            {
                var customer = from c in _customerRepository.Table
                               ...
                               where sm.EntityName == "Customer"
                                   && sm.StoreId == storeId && c.Id == customerId
                               select c;
        ...
        /// <summary>
        /// Get BlackBoardCustomerNumber by EmplId
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>


        //public Int64 GetBlackBoardCustomerNumber(int emplId)
        //{
        //    Int64 bbCustomerNumber;

        //    Int64 emplID = Convert.ToInt64(emplId);

        //    string connString = new DataSettingsManager().LoadSettings().DataConnectionString;
        //    string sql = "Select BBCustomerNumber from  FSU_EMPL_BB where EmplId =  @emplId";
        ...
        //        {
        //            conn.Open();
        //            bbCustomerNumber = (Int64)cmd.ExecuteScalar();
        //        }
        //        catch (Exception ex)
        //        {
        //            throw ex;
        ...
        #region NU-26
        public virtual IList<Customer> GetCustomersByVendor(Vendor vendor)
        {
            ...
            bool onlyInternal = false)  // NU-57
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                #region NU-57
                if(onlyInternal) {
                    int[] exclude = { SystemCustomerRoleNames.GuestsId, SystemCustomerRoleNames.RegisteredId };

                    query = from cr in query
                            where !(from e in exclude
                                    select e).Contains(cr.Id)
                            select cr;
                }
                #endregion
        ...
        public Commuter GetCommuterInfoForCustomer(string id, int storeId)
        {
            var query = _commuterRepository.Table;
            query = query.Where(c => c.StudentEmplId == id && c.StoreId == storeId);
