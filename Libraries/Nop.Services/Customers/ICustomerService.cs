...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        Customer GetCustomerByIdAndStoreId(int customerId, int storeId); /// NU-29

        IList<Customer> GetCustomersByVendor(Vendor vendor); /// NU-26
                                                             /// 
        Commuter GetCommuterInfoForCustomer(string id, int storeId);  //EC-5
