...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageProducts = new PermissionRecord { Name = "Admin area. Master Catalog. Products", SystemName = "ManageProducts", Category = "MasterCatalog" };	/// NU-10
        ...
        public static readonly PermissionRecord ManageReservations = new PermissionRecord { Name = "Admin area. Manage Reservations", SystemName = "ManageReservations", Category = "Reservations" };
		...
		#region SODMYWAY-
        public static readonly PermissionRecord ManageProductsCatalog = new PermissionRecord { Name = "Admin area. Catalog. Products", SystemName = "ManageProductsCatalog", Category = "Catalog" };
        public static readonly PermissionRecord ManageProductsCatalogAttributes = new PermissionRecord { Name = "Admin area. Catalog. Attributes", SystemName = "ManageProductsCatalogAttributes", Category = "Catalog" };
        public static readonly PermissionRecord ManageMessageQueueReadOnly = new PermissionRecord { Name = "Admin area. System. Message Queue. Read Only", SystemName = "ManageMessageQueueReadOnly", Category = "Configuration" };
        public static readonly PermissionRecord ManageCustomersCustomerRoles = new PermissionRecord { Name = "Admin area. Customers. Customer Roles", SystemName = "ManageCustomersCustomerRoles", Category = "Customers" };
        public static readonly PermissionRecord ManageCustomersReadOnly = new PermissionRecord { Name = "Admin area. Customers. Customers. Read Only", SystemName = "ManageCustomersReadOnly", Category = "Customers" };
		#endregion
        public static readonly PermissionRecord ManageDonations = new PermissionRecord { Name = "Admin area. Manage Donations", SystemName = "ManageMealPlans", Category = "Orders" };  /// NU-32

        public static readonly PermissionRecord ManageFulfillmentCalendar = new PermissionRecord { Name = "Admin area. Fulfillment Calendar", SystemName = "ManageFulfillmentCalendar", Category = "Configuration" };	// NU-91
        ...
        public virtual IEnumerable<PermissionRecord> GetPermissions()
        {
            return new[] 
            {
                ...
                AccessClosedStore,	
                ManageProductsCatalog,	/// SODMYWAY-
                ManageProductsCatalogAttributes,	/// SODMYWAY-
                ManageMessageQueueReadOnly,	/// SODMYWAY-
                ManageCustomersCustomerRoles,	/// SODMYWAY-
                ManageCustomersReadOnly,	/// SODMYWAY-
                ManageDonations, /// NU-32
                ManageFulfillmentCalendar	/// NU-91
            };
        }
