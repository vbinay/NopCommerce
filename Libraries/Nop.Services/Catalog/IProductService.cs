...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IList<ProductFulfillmentCalendar> GetUnavlblDates(int productId, DateTime fromDate, DateTime toDate);

        IList<ReservationProducts> GetReservationProductsbyProductId(int productId);

        IList<ReservedProduct> GetReservedProductbyProductId(int productId);

        ReservedProduct GetReservedProductbyOrderItemId(int orderItemId);

        IList<ProductFulfillmentCalendar> GetProductFulfillmentCalendarbyProductId(int productId);
        #endregion
        ...
        void DeleteReservationProducts(ReservationProducts reservationProduct);


        void InsertJeGlCodeAndAmountBusinessRules(ProductGlCodeMapping itemsMapping);
        ...
        void UpdateProductPickupWarehouse(int productID, int warehouseID);

        IList<ProductWarehouse> GetPickupWarehouseByProductId(int productId);

        void DeleteProductPickupWarehouse(ProductWarehouse warehouseData);
        ...
        Product GetProductById_Cache(int productId);
        ...
        void InsertReservationProducts(ReservationProducts reservationProduct);
        ...
        /// <param name="masterProductId">Product identifier; 0 to load all records</param>
        ...
        #region NU-10
        IList<int> GetProductChildren(Product product);

        Product GetProductMaster(Product product);
        #endregion

        IPagedList<ProductRelation> GetProductRelationsByStore(int pageIndex = 0, int pageSize = int.MaxValue, int storeId = 0);

        IPagedList<ProductRelation> GetProductRelationsByProduct(Product product, int pageSize = int.MaxValue, int pageIndex = 0);


        IList<ProductRelation> GetProductRelationsByStore(int storeId, int typeId);

        IList<ProductRelation> GetProductRelationsByProduct(int productId, int typeId);

        IList<ProductRelation> GetProductRelationsByRelatedProduct(int productId, int typeId);
        ...
        /// </summary>
        /// <param name="relatedProduct">Related product</param>
        void InsertProductRelation(RelatedProduct relatedProduct);

        /// <summary>
        /// Updates a related product
        /// </summary>
        /// <param name="relatedProduct">Related product</param>
        void UpdateProductRelation(RelatedProduct relatedProduct);


        void InsertStagingProductInfo(StagingProducts StagingProducts);


        bool StagingProductExists(int productId);

        StagingProducts GetStagingMapping(int productId);

        void UpdateStagingMapping(StagingProducts stagingProduct);
    }
}
