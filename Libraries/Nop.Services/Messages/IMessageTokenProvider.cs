...
namespace Nop.Services.Messages
{
    ...
    {
        void AddStoreTokens(IList<Token> tokens, Store store, EmailAccount emailAccount); //NU-90
        ...
        void AddDonationTokens(IList<Token> tokens, Order order, List<Donation> donations, int languageId, bool includeGiftAmount = false);
		#endregion

        void AddWarehouseTokens(IList<Token> tokens, int warehouseID, EmailAccount emailAccount);	// NU-84
    }
}
