...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        string SendOrderPlacedorDonationStoreOwnerNotification(int orderId, int languageId);
        /// <summary>
        /// Sends a corporate notification 
        /// </summary>
        ...
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendDonationPlacedForCorporateNotification(Order order, int languageId);
        ...
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        List<int> SendOrderPlacedCustomerOrDonationCustomerNotification(Order order, int languageId,
            string attachmentFilePath = null, string attachmentFileName = null);	
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendShipmentSentStoreOwnerNotification(Shipment shipment, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendShipmentDeliveredStoreOwnerNotification(Shipment shipment, int languageId);
        ...
        #region NU-17
        /// <summary>
        /// Send Donation Order Placed to Customer
        /// </summary>
        /// <param name="order"></param>
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendDonationOrderPlacedCustomerNotification(Order order, int languageId);

        /// <summary>
        /// Send "On Behalf Of" emails
        /// </summary>
        /// <param name="order"></param>
        /// <param name="languageId"></param>
        /// <returns></returns>
        List<int> SendDonationOrderPlacedOnBehalfOfNotifications(Order order, int languageId);

        /// <summary>
        /// Sends a gift notification to recipient
        /// </summary>
        /// <param name="order"></param>
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendCustomerOrderGiftNotification(Order order, int languageId, bool includePrice = true);
        #endregion
        #region SODMYWAY-
        /// <summary>
        /// This se
        ...
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendFulfillementCustomerNotification(OrderItem orderItem, int languageId);
        int SendCustomerCreationNotification(Customer customer, int languageId);
        #endregion
        ...
        #region NU-84
        int SendTestReceipt(int messageTemplateId, int languageId, string kitchenPrinterURL, string orderNumber);

        int SendOrderReceipts(int languageId, Order order);

        int SendReceipt(MessageTemplate messageTemplate,
