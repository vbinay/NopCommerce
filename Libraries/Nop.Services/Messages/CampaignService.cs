...
namespace Nop.Services.Messages
{
    public partial class CampaignService : ICampaignService
    {
        ...
        public CampaignService(IRepository<Campaign> campaignRepository,
            ...
            ICustomerService customerService, IStoreContext storeContext, IStoreService storeService,
        ...
        public virtual int SendCampaign(Campaign campaign, EmailAccount emailAccount, IEnumerable<NewsLetterSubscription> subscriptions)
        {
            ...
            foreach (var subscription in subscriptions)
            {
                ...
                _messageTokenProvider.AddStoreTokens(tokens, _storeContext.CurrentStore, emailAccount); //nu-90 changed the store contact
                ...
                var email = new QueuedEmail
                {
                    ...
                    DontSendBeforeDateUtc = !campaign.DontSendBeforeDateUtc.HasValue ? null : campaign.DontSendBeforeDateUtc
                };
        ...
        public virtual void SendCampaign(Campaign campaign, EmailAccount emailAccount, string email)
        {
            ...
            _emailSender.SendEmail(emailAccount, subject, body, storeContact.Email, storeContact.DisplayName, email, null);
        }
    }
}
