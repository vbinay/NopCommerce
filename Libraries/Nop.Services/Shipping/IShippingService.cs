...
namespace Nop.Services.Shipping
{
    ...
    public partial interface IShippingService
    {
        ...
        /// <summary>
        ///  Create shipment using UPS Shipping API, returns Tracking Number from UPS API
        /// </summary>
        /// <param name="ordItem">Order item</param>
        List<string> CreateShipmentWithUPSAPI(OrderItem ordItem);
        //---END: Codechages done by (na-sdxcorp\ADas)--------------

        //---START: Codechages done by (na-sdxcorp\ADas)--------------
        List<ShipmentReport> GetShipmentReports(IList<Order> orders);
        //---END: Codechages done by (na-sdxcorp\ADas)--------------
        #endregion
    }
}
