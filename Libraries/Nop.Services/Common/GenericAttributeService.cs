...
namespace Nop.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        public virtual GenericAttribute GetAttributeByEntityId_Keygroup_KeyName_StoreId(int entityId, string keyGroup, string keyName, int storeId)
        {
            var query = from ga in _genericAttributeRepository.Table
                        ...
                        ga.StoreId == storeId
                        select ga;
            var attributes = query.ToList().FirstOrDefault();
            return attributes;
        }
        ...
        public virtual void SavePaymentAttribute<TPropType>(BaseEntity entity, string key, TPropType value, int storeId = 0)
        {
            try
            {
