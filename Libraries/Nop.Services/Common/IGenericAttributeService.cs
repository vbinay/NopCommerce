...
namespace Nop.Services.Common
{
    ...
    public partial interface IGenericAttributeService
    {
        ...
        GenericAttribute GetAttributeByEntityId_Keygroup_KeyName_StoreId(int entityId, string keyGroup, string keyName, int storeId);
        ...
        void SavePaymentAttribute<TPropType>(BaseEntity entity, string key, TPropType value, int storeId = 0);
    }
}