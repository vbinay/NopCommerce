...
namespace Nop.Services.Common
{
    ...
    public partial interface IPdfService
    {
        ...
        void PrintShippingLabelToPdf(Stream stream, byte[] pdfBase64);
        ...
        void PrintStoreCommissionsToPdf(Stream stream, IList<StoreCommissionReportLineModel> commissions); /// NU-64
    }
}