...
namespace Nop.Services.Common
{
    ...
    public partial class AddressService : IAddressService
    {
        ...
        public IList<Address> IsUPSAddressValid(Address address)
        {
            ...
            string json = String.Format(@"{
             ...
             'XAVRequest': {
              ...
              'AddressKeyFormat': {
               ...
               'AddressLine': '{0}',
               'PoliticalDivision2': '{1}',
               'PoliticalDivision1': '{2}',
               'PostcodePrimaryLow': '{3}',
               'CountryCode': 'US'
              }
             }
            }",address.Address1, address.City, address.StateProvince.Abbreviation, address.ZipPostalCode);

            string result = "";
            using (var client = new WebClient())
            {
                client.Headers[HttpRequestHeader.ContentType] = "application/json";
                result = client.UploadString("https://onlinetools.ups.com/rest/XAV", "POST", json);
            }
