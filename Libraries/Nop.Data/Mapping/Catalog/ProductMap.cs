...
namespace Nop.Data.Mapping.Catalog
{
    public partial class ProductMap : NopEntityTypeConfiguration<Product>
    {
        public ProductMap()
        {
            ...
            this.Property(p => p.StoreCommission).HasPrecision(18, 4);  /// NU-15
            this.Property(p => p.IsReservation);
            this.Property(p => p.ReservationStartTime);
            this.Property(p => p.ReservationEndTime);
            this.Property(p => p.ReservationInterval);
            this.Property(p => p.MaxOccupancy);
