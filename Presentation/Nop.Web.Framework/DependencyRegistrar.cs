...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
			...
			#region SODMYWAY-
            //Add in Tridion Site Start dependency and Tridion Profile Mapping Service 
            //builder.RegisterType<TridionProfileMappingService>()
            //    .As<ITridionProfileMappingService>()
            //    .InstancePerLifetimeScope();
            //builder.RegisterType<SiteStartProcessor>().As<ISiteStartProcessor>().InstancePerRequest();
			#endregion
            
            builder.RegisterType<SsoAuth>().As<ISsoAuth>().InstancePerRequest();	/// SODMYWAY-
            //cache managers
            ...
            builder.RegisterType<MealPlanService>().As<IMealPlanService>().InstancePerLifetimeScope();	/// SODMYWAY-
            ...
            builder.RegisterType<ProductFulfillmentService>().As<IProductFulfillmentService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<DonationService>().As<IDonationService>().InstancePerLifetimeScope(); /// SODMYWAY-
            builder.RegisterType<CardAccessService>().As<ICardAccessService>().InstancePerLifetimeScope(); /// SODMYWAY-
            builder.RegisterType<FulfillmentService>().As<IFulfillmentService>().InstancePerLifetimeScope(); /// SODMYWAY-
            builder.RegisterType<OrderService>().As<IOrderService>().InstancePerLifetimeScope();

            builder.RegisterType<ReportingService>().As<IReportingService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<GlCodeService>().As<IGlCodeService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<SAPService>().As<ISAPService>().InstancePerLifetimeScope();	// NU-63
        }
