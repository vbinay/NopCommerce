...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        protected virtual void PrepareSortingOptions(CatalogPagingFilteringModel pagingFilteringModel, CatalogPagingFilteringModel command)
        {
            ...
            if (pagingFilteringModel.AllowProductSorting)
            {
                foreach (var option in activeOptions)
                {
                    ...
                    var sortUrl = _webHelper.ModifyQueryString(currentPageUrl, "orderby=" + (option.Key).ToString() + "&clicked=products-orderby", null);
        ...
        protected virtual void PrepareViewModes(CatalogPagingFilteringModel pagingFilteringModel, CatalogPagingFilteringModel command)
        {
            ...
            if (pagingFilteringModel.AllowProductViewModeChanging)
            {
                ...
                pagingFilteringModel.AvailableViewModes.Add(new SelectListItem
                {
                    ...
                    Value = _webHelper.ModifyQueryString(currentPageUrl, "viewmode=grid&clicked=grid-view", null),
                ...
                pagingFilteringModel.AvailableViewModes.Add(new SelectListItem
                {
                    ...
                    Value = _webHelper.ModifyQueryString(currentPageUrl, "viewmode=list&clicked=list-view", null),
            ...
            bool allowCustomersToSelectPageSize, string pageSizeOptions, int fixedPageSize)
        {
            ...
            if (allowCustomersToSelectPageSize && pageSizeOptions != null)
            {
                ...
                if (pageSizes.Any())
                {
                    ...
                    var currentPageUrl = _webHelper.GetThisPageUrl(true);
                    var sortUrl = _webHelper.ModifyQueryString(currentPageUrl, "pagesize={0}&clicked=products-pagesize", null);
                    ...
                    if (flagAll == 1)
                    {
                        ...
                        {
                            Text = addAll,
                            Value = String.Format(sortUrl, allVal),
                            Selected = isAllSeleted
                        });
                    }
                }
            }
            ...
            bool loadSubCategories = true, IList<Category> allCategories = null)
        {
            ...
            categories = allCategories.Where(c => c.ParentCategoryId == rootCategoryId).ToList();
        ...
        public ActionResult Category(int categoryId, CatalogPagingFilteringModel command)
        {
            ...
            model.SubCategories = _cacheManager.Get(subCategoriesCacheKey, () =>
                ...
                .Select(x =>
                {
                    ...
                    var id = new List<int>();
                    id.Add(x.Id);
                    subCatModel.NumOfProducts = _productService.GetNumberOfProductsInCategory(id, _storeContext.CurrentStore.Id);
                    #endregion
                    ...
                    subCatModel.PictureModel = _cacheManager.Get(categoryPictureCacheKey, () =>
                    {
                        ...
                        var pictureModel = new PictureModel
                        {
                            ...
                            AlternateText = (!string.IsNullOrEmpty(_localizationService.GetResource("Media.Category.ImageAlternateTextFormat"))) ? string.Format(_localizationService.GetResource("Media.Category.ImageAlternateTextFormat"), subCatModel.Name) : subCatModel.Name
                        };
                        return pictureModel;
                    });

                    return subCatModel;
                }).Where(x => x.NumOfProducts > 0)
                .ToList()
            );
        ...
        public ActionResult CategoryNavigation(int currentCategoryId, int currentProductId)
        {
            ...
            var cachedModel = PrepareCategorySimpleModels(0).ToList();
        ...
        public ActionResult HomepageCategories()
        {
            ...
            var model = _categoryService.GetAllCategoriesDisplayedOnHomePage()
                .Select(x =>
                {
                    ...
                    catModel.NumProducts = _productService.GetNumberOfProductsInCategory(ids, _storeContext.CurrentStore.Id);
                    #endregion
            ...
            foreach (var manufacturer in manufacturers)
            {
                ...
                modelMan.PictureModel = _cacheManager.Get(manufacturerPictureCacheKey, () =>
                {
                    ...
                    var pictureModel = new PictureModel
                    {
                        ...
                        AlternateText = (!string.IsNullOrEmpty(_localizationService.GetResource("Media.Manufacturer.ImageAlternateTextFormat"))) ? string.Format(_localizationService.GetResource("Media.Manufacturer.ImageAlternateTextFormat"), modelMan.Name) : modelMan.Name
                    };
                    return pictureModel;
                });
                model.Add(modelMan);
            ...
            foreach (var vendor in vendors)
            {
                ...
                vendorModel.PictureModel = _cacheManager.Get(pictureCacheKey, () =>
                {
                    ...
                    var pictureModel = new PictureModel
                    {
                        ...
                        AlternateText = (!string.IsNullOrEmpty(_localizationService.GetResource("Media.Vendor.ImageAlternateTextFormat"))) ? string.Format(_localizationService.GetResource("Media.Vendor.ImageAlternateTextFormat"), vendorModel.Name) : vendorModel.Name
                    };
                    return pictureModel;
                });
