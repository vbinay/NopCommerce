...
namespace Nop.Web.Models.Order
{
    public partial class OrderDetailsModel : BaseNopEntityModel
    {
        ...
        public partial class OrderItemModel : BaseNopEntityModel
        {
            ...
            public Nop.Core.Domain.Shipping.Warehouse SelectedFulfillmentWarehouse { get; set; }
            public int? SelectedFulfillmentWarehouseId { get; set; }
            ...
            public String RequestedFulfillmentDeliveryDateTimeDisplay
            {
                get
                {
                    ...
                    if (SelectedFulfillmentWarehouse != null)
                    {
                        if (this.RequestedFulfillmentDateTime != null)
                        {
                            if (this.SelectedFulfillmentWarehouse.AllowDeliveryTime)
                            {
            ...
            public String RequestedFulfillmentPickupDateTimeDisplay
            {
                get
                {
                    ...
                    if (SelectedFulfillmentWarehouse != null)
                    {
                        if (this.RequestedFulfillmentDateTime != null)
                        {
                            if (this.SelectedFulfillmentWarehouse.AllowPickupTime)
                            {
                                return this.RequestedFulfillmentDateTime.ToString();
                            }
                            else
