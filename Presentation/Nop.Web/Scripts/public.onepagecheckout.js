...
var Checkout = {
    ...
    gotoSection: function (section) {       
        $('#opc-' + section + ' a').removeAttr('aria-disabled');
        $('#opc-' + section + ' a').removeAttr('tabindex');
        section = $('#opc-' + section);
...
var Shipping = {
    ...
    resetLoadWaiting: function () {
        ...
        //$('#plnAddress').html($('#div_AddressPopup').context.children['1'].innerHTML);
        //var address_html = $('.content_address').html();
        //if (address_html != null) {
        //    $('#plnAddress').html(address_html);
        //    $('#plnAddress').dialog({
        //        modal: true,
...
//---START: Codechages done by (na-sdxcorp\ADas)--------------
function selectShippingAddress(addressLine, stateID, city, postalCode) {
 
    //$('#plnAddress').dialog('close');
    //$('#plnAddress').empty();

    $('#ShippingNewAddress_Address1').val(addressLine);
    $('#ShippingNewAddress_City').val(city);
    $('#ShippingNewAddress_ZipPostalCode').val(postalCode);
    $('#ShippingNewAddress_StateProvinceId').val(stateID).change();

    $('#div_AddressPopup').html('');
}
function selectBillingAddress(addressLine, stateID, city, postalCode) {
    //$('#plnAddress').dialog('close');
    //$('#plnAddress').empty();

    $('#BillingNewAddress_Address1').val(addressLine);
    $('#BillingNewAddress_City').val(city);
    $('#BillingNewAddress_ZipPostalCode').val(postalCode);
    $('#BillingNewAddress_StateProvinceId').val(stateID).change();
...
var ShippingMethod = {
    ...
    //validate: function() {
    //    var methods = $("[id^=shippingoption]");	/// SODMYWAY-
    //    if (methods.length == 0) {
