...
namespace Nop.Admin.Models.Customers
{
    ...
    public partial class CustomerModel : BaseNopEntityModel
    {
        public CustomerModel()
        {
            ...
            this.StoreMappingAvailableStores = new List<SelectListItem>();
        }
        ...
        public partial class OrderModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Admin.Customers.Customers.Orders.ProductCount")]
        ...
        public bool IsSystemGlobalAdmin { get; set; }	// NU-1
        ...
        public bool IsInternal { get; set; }    // NU-56

        #region NU-62

        [NopResourceDisplayName("Admin.Customers.Customers.StoreMapping.Add")]
        public int AddStoreMappingStoreId { get; set; }
        public int AddStoreMappingValue { get; set; }
        public string AddStoreMappingMessage { get; set; }
        public IList<SelectListItem> StoreMappingAvailableStores { get; set; }
        #endregion
    }
}