...
namespace Nop.Admin.Models.Orders
{
    public partial class OrderListModel : BaseNopModel
    {
        public OrderListModel()
        {
            ...
            AvailableFulfillment = new List<SelectListItem>();
        }
        ...
        [NopResourceDisplayName("Admin.Orders.List.FulfillmentStatus")]
        ...
        public IList<SelectListItem> AvailableFulfillment { get; set; }
