...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        public ProductModel()
        {
            ...
            AvailablePickupWarehouses = new List<SelectListItem>(); 	// NU-13 
            ...
            SelectedPaidGlCodeIds = new List<int>();
            SelectedDeferredGlCodeIds = new List<int>();
            ...
            AvailablePaidGLCodes = new List<SelectListItem>();
            AvailableDeferredGLCodes = new List<SelectListItem>();
        }

        
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.IsReservation")] //CC- 394/400
        public bool IsReservation { get; set; }

        public bool IsBundleProduct { get; set; }

        public IList<SelectListItem> ReservationStartHour;
        public int ReservationSelectedStartHour { get; set; }

        public IList<SelectListItem> ReservationStartMinute;
        public int ReservationSelectedStartMinute { get; set; }

        public IList<SelectListItem> ReservationStartAMPM;
        public string ReservationSelectedStartAMPM { get; set; }

        public IList<SelectListItem> ReservationEndHour;
        public int ReservationSelectedEndHour { get; set; }

        public IList<SelectListItem> ReservationEndMinute;
        public int ReservationSelectedEndMinute { get; set; }

        public IList<SelectListItem> ReservationEndAMPM;
        public string ReservationSelectedEndAMPM { get; set; }
        ...
        public int MaxWindowDays { get; set; }

        public int ReservationCapPerSlot { get; set; }

        public int ReservationTimeInterval { get; set; }

        public ProductFulfillmentCalendar ProductFulfillmentCalendar { get; set; }

        public IList<ReservationProducts> ReservationProducts { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ID")]
        public override int Id { get; set; }

        public string TimeZone = "Add time in EST";
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.AlternateProductName")]
        public string AlternateProductName { get; set; }

        //EC-5
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.CustomerMaximumQuantity")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.StoreName")]
        [AllowHtml]
        ...
        #region NU-17
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.IsDonation")]
        public bool IsDonation { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.IsCorporateDonation")]
        ...
        public  string RequireOtherProductsOption { get; set; }

        public string RequiredProductsOption { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.IsLocalDelivery")]
        ...
        public int MaxDiscountQuantity { get; set; }
        public IList<SelectListItem> AvailableTaxCategories { get; set; }

        //[NopResourceDisplayName("Admin.Catalog.Products.Fields.TaxRequestQuantity")] //NU-90
        //public string TaxRequestQuantity { get; set; }
        ...
        #region NU-13
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.PreferredPickupWarehouseId")]
        public int PreferredPickupWarehouseId { get; set; }
        [UIHint("MultiSelect")]
        public IList<int> SelectedWarehouseIds { get; set; }
        public IList<SelectListItem> AvailablePickupWarehouses { get; set; }
        #endregion
        ...
        //EC-5
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.LimitPurchase")]
        public bool LimitPurchase { get; set; }

        //EC-5
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.LimitPurchaseType")]
        public int? LimitPurchaseType { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.DisableBuyButtonForGuestUsers")]
        public bool DisableBuyButtonForGuestUsers { get; set; }
        ...
        public bool EnableLocalAdminPublish { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.UpdatedBy")]
        ...
        public string PrimaryTimeZone { get { return TimeZone; } set { TimeZone = value; } }
        ...
        //categories
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.DeferredGlCodes")]
        [UIHint("MultiSelect")]
        public IList<int> SelectedDeferredGlCodeIds { get; set; }
        public IList<SelectListItem> AvailableDeferredGLCodes { get; set; }

        //categories
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.PaidGlCodes")]
        [UIHint("MultiSelect")]
        public IList<int> SelectedPaidGlCodeIds { get; set; }
        public IList<SelectListItem> AvailablePaidGLCodes { get; set; }


        // public GLCodeModel GLCodeModel { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProductRelationTypes")]
        [UIHint("MultiSelect")]
        public IList<int> SelectedRelationTypeIds { get; set; }
        public IList<SelectListItem> AvailableRelationTypes { get; set; }
        ...
        #region NU-15
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.StoreCommission")]
        [UIHint("DecimalNullable")]
        ...
        #region NU-16
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.IsMealPlan")]
        public bool IsMealPlan { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ShowStandardMealPlanFields")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.IsPickupEnabled")]
        public bool IsPickupEnabled { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.HasPickupFee")]
        public bool HasPickupFee { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.AdditionalPickupCharge")]
        public decimal AdditionalPickupCharge { get; set; }
        #endregion
        ...
        /// Gets checkout notes.
        /// </summary>
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.CheckoutNotes")]
        public String CheckoutNotes { get; set; }
        #endregion

        #region NU-10
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.IsMaster")]
        public bool IsMaster { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MasterId")]
        public int MasterId { get; set; }
        #endregion

        #region NU-18
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProductionDaysLead")]
        public int? ProductionDaysLead { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProductionMinutesLead")]
        public int? ProductionMinutesLead { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProductionHoursLead")]
        public int? ProductionHoursLead { get; set; }
        #endregion

        #region CC-44 Auto-fulfill products fulfillment types should reflect the master configuration
        public bool IsAutoFulfill
        {
            get
            {
                if (this.IsMealPlan || this.IsDownload || this.IsDonation)
                    return true;
                return false;
            }
        }
        ...
        public String Url { get; set; } /// SODMYWAY-
