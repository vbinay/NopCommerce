...
namespace Nop.Admin.Models.Settings
{
    public partial class ProductEditorSettingsModel : BaseNopModel
    {
		...
		#region NU-10
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.IsMaster")]
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.SpecialPrice")]
        public bool SpecialPrice { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.SpecialPriceStartDate")]
        public bool SpecialPriceStartDate { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.SpecialPriceEndDate")]
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.DisableBuyButtonForGuestUsers")]
		...
		#region SODMYWAY-
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.IsMealPlan")]
		...
		#region SODMYWAY-
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.IsDonation")]
		...
		#region SODMYWAY-
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.DeliveryMethods")]
        public bool DeliveryMethods { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.StoreCommission")]
        public bool StoreCommission { get; set; }
        #endregion

        #region SODMYWAY- CC-394/400
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.IsReservation")]
