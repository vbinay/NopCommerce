...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static GLCodeModel ToModel(this GlCode entity)
        {
            return entity.MapTo<GlCode, GLCodeModel>();
        }

        public static GlCode ToEntity(this GLCodeModel model)
        {
            return model.MapTo<GLCodeModel, GlCode>();
        }

        public static GlCode ToEntity(this GLCodeModel model, GlCode destination)
        {
            return model.MapTo(destination);
        }
        ...
        public static StoreContactModel ToModel(this StoreContact entity)
        {
            return entity.MapTo<StoreContact, StoreContactModel>();
        }

        public static StoreContact ToEntity(this StoreContactModel model)
        {
            return model.MapTo<StoreContactModel, StoreContact>();
        }

        public static StoreContact ToEntity(this StoreContactModel model, StoreContact destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        public static MealPlanModel ToModel(this MealPlan entity)
        {
            return new MealPlanModel
            {
                Id = entity.Id,
                PurchasedWithOrderItemId = entity.PurchasedWithOrderItemId,
                RecipientAcctNum = entity.RecipientAcctNum,
        ...
        public static MealPlan ToEntity(this MealPlanModel model)
        {
            return new MealPlan
            {
                Id = model.Id,
                PurchasedWithOrderItemId = model.PurchasedWithOrderItemId,
                RecipientAcctNum = model.RecipientAcctNum,
        ...
        public static MealPlan ToEntity(this MealPlanModel model, MealPlan destination)
        {
            destination.Id = model.Id;
            destination.PurchasedWithOrderItemId = model.PurchasedWithOrderItemId;
            destination.RecipientAcctNum = model.RecipientAcctNum;
            destination.RecipientAddress = model.RecipientAddress;
            destination.RecipientEmail = model.RecipientEmail;
            destination.RecipientName = model.RecipientName;
            destination.RecipientPhone = model.RecipientPhone;
        ...
        public static TaxResponseStorageModel ToModel(this TaxResponseStorage entity)
        {
            return new TaxResponseStorageModel
            {
                Id = entity.Id,
                AddedDate = entity.AddedDate,
                CustomerID = entity.CustomerID,
                ProductID = entity.ProductID,
                TypeOfCall = entity.TypeOfCall,
               // XMlResponse = entity.XMlResponse
            };
        }

        public static TaxResponseStorage ToEntity(this TaxResponseStorageModel model)
        {
            return new TaxResponseStorage
            {
                Id = model.Id,
                AddedDate = model.AddedDate,
                CustomerID = model.CustomerID,
                ProductID = model.ProductID,
                TypeOfCall = model.TypeOfCall,
            //    XMlResponse = model.XMlResponse,

            };
        }

        public static TaxResponseStorage ToEntity(this TaxResponseStorageModel model, TaxResponseStorage destination)
        {
            destination.Id = model.Id;
            destination.AddedDate = model.AddedDate;
            destination.CustomerID = model.CustomerID;
            destination.ProductID = model.ProductID;
            destination.TypeOfCall = model.TypeOfCall;
//            destination.XMlResponse = model.XMlResponse;
        ...
        #region NU-17
        public static DonationModel ToModel(this Donation entity)
        {
            return new DonationModel
            {
                ...
                DonorCompany = entity.DonorCompany,
                DonorAddress = entity.DonorAddress,
                DonorAddress2 = entity.DonorAddress2,
                DonorCity = entity.DonorCity,
                DonorState = entity.DonorState,
                DonorZip = entity.DonorZip,
                DonorPhone = entity.DonorPhone,
                DonorCountry = entity.DonorCountry,
                Comments = entity.Comments,
                NotificationEmail = entity.NotificationEmail,
                OnBehalfOfFullName = entity.OnBehalfOfFullName,
                IsProcessed = entity.IsProcessed
            };
        }

        public static Donation ToEntity(this DonationModel model)
        {
            return new Donation
            {
                Id = model.Id,
                ...
                DonorCompany = model.DonorCompany,
                DonorAddress = model.DonorAddress,
                DonorAddress2 = model.DonorAddress2,
                DonorCity = model.DonorCity,
                DonorState = model.DonorState,
                DonorZip = model.DonorZip,
                DonorPhone = model.DonorPhone,
                DonorCountry = model.DonorCountry,
                Comments = model.Comments,
                NotificationEmail = model.NotificationEmail,
                OnBehalfOfFullName = model.OnBehalfOfFullName,
                IsProcessed = model.IsProcessed
            };
        }

        public static Donation ToEntity(this DonationModel model, Donation destination)
        {
            destination.Id = model.Id;
            destination.PurchasedWithOrderItemId = model.PurchasedWithOrderItemId;
            destination.DonorFirstName = model.DonorFirstName;
            destination.DonorLastName = model.DonorLastName;
            destination.DonorCompany = model.DonorCompany;
            destination.DonorAddress = model.DonorAddress;
            destination.DonorAddress2 = model.DonorAddress2;
            destination.DonorCity = model.DonorCity;
            destination.DonorState = model.DonorState;
            destination.DonorZip = model.DonorZip;
            destination.DonorPhone = model.DonorPhone;
            destination.DonorCountry = model.DonorCountry;
            destination.Comments = model.Comments;
            destination.NotificationEmail = model.NotificationEmail;
            destination.OnBehalfOfFullName = model.OnBehalfOfFullName;
        ...
        #region NU-63
        public static SAPSettingsModel ToModel(this SAPSettings entity)
        {
            return new SAPSettingsModel
            {
                ...
                SshHostKeyFingerprint = entity.SshHostKeyFingerprint,
        ...
        public static SAPSettings ToEntity(this SAPSettingsModel model)
        {
            return new SAPSettings
            {
                ...
                SshHostKeyFingerprint = model.SshHostKeyFingerprint,
        ...
        public static SAPSettings ToEntity(this SAPSettingsModel model, SAPSettings destination)
        {
            destination.Protocol = model.Protocol;
            destination.Hostname = model.Hostname;
            destination.UserName = model.UserName;
            destination.Password = model.Password;
            destination.PortNumber = model.PortNumber;
            destination.SshHostKeyFingerprint = model.SshHostKeyFingerprint;
            destination.localPath = model.localPath;
            destination.remotePath = model.remotePath;
            destination.remove = model.remove;
