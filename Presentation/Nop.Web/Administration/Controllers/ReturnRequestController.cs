...
namespace Nop.Admin.Controllers
{
    public partial class ReturnRequestController : BaseAdminController
    {
        ...
        public ActionResult List(DataSourceRequest command)
        {
            ...
            var returnRequests = _returnRequestService.SearchReturnRequests(_storeContext.CurrentStore.Id, // NU-42
				0, 0, null, command.Page - 1, command.PageSize);
            ...
            var gridModel = new DataSourceResult
            {
                Data = returnRequestModels.
					OrderByDescending(r => r.Id), /// NU-37
