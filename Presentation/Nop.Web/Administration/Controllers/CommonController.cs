...
namespace Nop.Admin.Controllers
{
    public partial class CommonController : BaseAdminController
    {
        ...
        public ActionResult HelpTour()
        {
            return View("HelpTour", new HelpViewModel()
            {
                Steps = {
        ...
        public ActionResult SystemInfo()
        {
			...
			#region SODMYWAY-
            model.IsSysAdm = _workContext.CurrentCustomer.IsSystemGlobalAdmin();
            model.ConnectionString = new DataSettingsManager().LoadSettings().DataConnectionString;	
			#endregion
            return View(model);
        }
