...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //routes.MapLocalizedRoute("Login",
            //                "login/",
            //                new { controller = "Customer", action = "TridionLogin" },	/// SODMYWAY-
            //                new[] { "Nop.Web.Controllers" });
            //register
            ...
            routes.MapLocalizedRoute("AddProductToCart-Catalog",
                            ...
                            new[] { "Nop.Web.Controllers" });
			#region SODMYWAY-
            routes.MapLocalizedRoute("AddProductsToCart-Catalog",
                "addproductstocart/catalog/{productIdsAndQuantities}",
                new { controller = "ShoppingCart", action = "AddProductToCart_List",  productIdsAndQuantities = new  List<string>() },
                new[] { "Nop.Web.Controllers" });
			#endregion
            ...
            routes.MapLocalizedRoute("GetCategories",
                          "staging/getcategories",
                          new { controller = "Staging", action = "GetCategories"}, 
                          new[] { "Nop.Web.Controllers" });
            ...
            #region SODMYWAY-
            //
            routes.MapLocalizedRoute("CustomerMealPlans",
                       "customer/mealplans",
                       new { controller = "Order", action = "CustomerMealPlans" },
                       new[] { "Nop.Web.Controllers" }); 

            //check cardsystem account number
            routes.MapRoute("ValidateCardSystemAccount",
                            "validateCardSystemAccount",
                            new { controller = "Product", action = "ValidateCardSystemAccount" },
                            new[] { "Nop.Web.Controllers" });
			...
			#region SODMYWAY-
            //Tridion site resource routes
            routes.MapLocalizedRoute("Javascript",
                "JS/{*fileName}",
                new { controller = "TridionResource", Action = "Js" }
                );
            routes.MapLocalizedRoute("Css",
                "CSS/{*fileName}",
                new { controller = "TridionResource", Action = "Css" }
                );
            routes.MapLocalizedRoute("Images",
                "images/{*fileName}",
                new { controller = "TridionResource", Action = "Images" }
                );
			#endregion
        }
