...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        /// {2} : is connection SSL secured (included in a picture URL)
        /// </remarks>
        public const string STORE_BANNER_PATH = "Nop.pres.banner-{0}-{2}";
        public const string STORE_BANNER_PATH_PATTERN_KEY = "Nop.pres.banner";
        ...
        /// {2} : is connection SSL secured (included in a picture URL)
        /// </remarks>
        public const string STORE_BANNERMARKUP_PATH = "Nop.pres.banner-{0}-{2}";
        public const string STORE_BANNERMARKUP_PATH_PATTERN_KEY = "Nop.pres.bannermarkup";
        ...
        public const string HEADER_BANNER_MODEL_KEY = "Nop.pres.header.banner-{0}-{1}-{2}";
        ...
        public void HandleEvent(EntityUpdated<Setting> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(STORE_BANNER_PATH_PATTERN_KEY); //depends on StoreInformationSettings.LogoPictureId	
            _cacheManager.RemoveByPattern(STORE_BANNERMARKUP_PATH_PATTERN_KEY); //depends on StoreInformationSettings.LogoPictureId	
        }
