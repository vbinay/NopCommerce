...
CREATE PROCEDURE [dbo].[_ProductLoadAllPaged]
(
	...
	@VendorId			int = 0,
	@WarehouseId		int = 0,
	@MasterProductId	int = 0, --JIRA - 2945
	...
	@OverrideHideMasterProducts	bit = 0, 
